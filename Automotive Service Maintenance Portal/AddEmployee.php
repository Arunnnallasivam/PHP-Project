...
<body id="bdy-main">
	...
	include('Db.php');
	$query= mysql_query("Select Count(*)+1 as data From EmployeeTable", $con);
	$row = mysql_fetch_array($query);
	$Id="E" . sprintf("%03d",$row['data']);
	?>
	<form action="AddEmployeeCode.php" method="post">
		<table class="tbl" align="center">
			<tr>
				<td colspan="6" class="heading">EMPLOYEE REGISTRATION</td>
			</tr>
			<tr>
				<td><br></td> 
			</tr>
